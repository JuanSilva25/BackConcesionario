# Generated by Django 4.2.6 on 2023-11-21 18:38
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('precioTotal', models.DecimalField(blank=True, decimal_places=2, default=Decimal('0.0'), editable=False, max_digits=10)),
                ('sucursal', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='modulos.sucursal')),
                ('vendedor_id', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='modulos.usuario')),
            ],
            options={
                'db_table': 'Venta',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('precio_unitario_vehiculo', models.DecimalField(decimal_places=2, default=0.0, editable=False, max_digits=10)),
                ('precio_unitario_repuesto', models.DecimalField(decimal_places=2, default=0.0, editable=False, max_digits=10)),
