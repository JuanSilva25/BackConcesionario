...
class DetalleVenta(models.Model):
    ...
    precio_unitario_vehiculo = models.DecimalField(max_digits=20, decimal_places=2, default=0.0, editable=False)
    precio_unitario_repuesto = models.DecimalField(max_digits=20, decimal_places=2, default=0.0, editable=False)
